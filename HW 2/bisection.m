function[x_, fx_, n_itr, err_abs] = bisection(f, a, b, tlr, n_max)
...
for i=1:n_max
    ...
    elseif feval(f, a)*feval(f, b) > 0
        ...
        x_0 = (a+b)./2; %bisection iteration formula
        ...
        err_abs = [err_abs; abs(b - a)]; %update the array for absolute error
        fprintf("After iteration no. %d, x_%d = %0.9f \n", i, i, x_0)
        if abs(b - a) < tlr
